...
public interface IEnigmaPlayerControls {
    ...
    void setSubtitleTrackById(String trackId);
    void setSubtitleTrack(ISubtitleTrack track, IControlResultHandler resultHandler);
    void setSubtitleTrackById(String trackId, IControlResultHandler resultHandler);
    void setAudioTrack(IAudioTrack track);
    void setAudioTrackById(String trackId);
    void setAudioTrack(IAudioTrack track, IControlResultHandler resultHandler);
    void setAudioTrackById(String trackId, IControlResultHandler resultHandler);
